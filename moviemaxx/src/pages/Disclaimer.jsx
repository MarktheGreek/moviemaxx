      ...
      <div className="static-container">
        ...
        <div className="disclaimer-content">
          <section className="disclaimer-section">
            ...
            <p>
              <strong>MovieMax does not host any files on its server.</strong> All content provided on this platform 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              ...
              no liability in respect of any such content. All content available through MovieMax remains 
